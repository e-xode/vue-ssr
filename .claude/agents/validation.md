...
Which stages run for a given set of modified files is enforced in `scripts/validate.mjs`. See the `vue-ssr-validation` skill for the full table — do not guess it from memory.
